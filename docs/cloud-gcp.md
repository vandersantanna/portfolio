...
[![GCP](https://img.shields.io/badge/GCP-Portfolio-4285F4?logo=google-cloud&logoColor=white)](#)
...
### GCP-Specific Notes
- **Workload Identity Federation** for GitHub Actions to avoid long-lived keys.
